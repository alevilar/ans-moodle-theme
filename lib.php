...
function anses_process_css($css, $theme) {
    ...
    $css = anses_set_regionwidth($css, $regionwidth);
    ...
    $css = anses_set_customcss($css, $customcss);
 ...
 * @return string
 */
function anses_set_regionwidth($css, $regionwidth) {
 ...
 * @return string
 */
function anses_set_customcss($css, $customcss) {
